  ...
  const REVIEWS = [
    {
      ...
      work: "Тени прошлого",
      workHref: "story-interactive.html",
      chapter: "Глава 5. Признание",
      chapterHref: "read-interactive.html?chapter=5",
    },
    {
      role: "author",
      ...
      chapterHref: "read-interactive.html?chapter=2",
    },
    {
      role: "author",
      ...
      workHref: "story-jujutsu-mixed.html",
      chapter: "Глава 1. Перекрёсток",
      chapterHref: "read-interactive.html?chapter=1",
    },
    {
      role: "author",
      ...
      workHref: "story-bts-slash.html",
      chapter: "Глава 3. Зал",
      chapterHref: "read-interactive.html?chapter=3",
    },
    {
      role: "coauthor",
      ...
      workHref: "story-linear.html",
      chapter: "Глава 3. Последняя строка",
      chapterHref: "read-linear.html?chapter=3",
    },
    {
      role: "editor",
      ...
      workHref: "story-hp-femslash.html",
      chapter: "Глава 2. Кухня",
      chapterHref: "read-linear.html?chapter=2",
    },
  ];
